...
fn build_single_plugin(
    ...
    cargo_cmd
        ...
        // Generated parsers need enough optimization to stay within WASM's
        // per-function local limit, but size optimization can exhaust hosted
        // runner memory on the largest parsers. `-O1` is the workable middle.
        .env("ARBORIUM_C_OPT_LEVEL", "1")
